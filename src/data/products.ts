...
import bleskNeo from "@/assets/products/blesk-neo.png";
import bleskNeoSide from "@/assets/products/blesk-neo-side.png";
import bleskFl from "@/assets/products/blesk-fl.png";
import bleskSlv from "@/assets/products/blesk-slv.png";
...
import wpThreadedPlugAsset from "@/assets/products/waterpro-threaded-plug.png";
import wpClamp16Asset from "@/assets/products/waterpro-clamp-16.png";
import wpMetalClampAsset from "@/assets/products/waterpro-metal-clamp.png";
...
import wpElbowZ from "@/assets/products/waterpro-elbow-z.png";
import wpWallCouplingLeft from "@/assets/products/waterpro-wall-coupling-left.png";
...
import wpAdapterMale from "@/assets/products/waterpro-adapter-male.png";
import wpAdapterFemale from "@/assets/products/waterpro-adapter-female.png";
...
import wpGateValve1062 from "@/assets/products/waterpro-gate-valve-1062.png";
import wpEmbeddedValve1063 from "@/assets/products/waterpro-embedded-valve-1063.png";
import wpBallValve1064 from "@/assets/products/waterpro-ball-valve-1064.png";
import wpCheckValve1065 from "@/assets/products/waterpro-check-valve-1065.png";
import wpBallValve1066 from "@/assets/products/waterpro-ball-valve-1066.png";
import wpStopValve1067 from "@/assets/products/waterpro-stop-valve-1067.png";
import wpStopValve1068 from "@/assets/products/waterpro-stop-valve-1068.png";
import wpValveCartridge1069 from "@/assets/products/waterpro-valve-cartridge-1069.png";
...
import wpDoubleElbow1078 from "@/assets/products/waterpro-double-elbow-1078.png";
import wpStopCheckValve1077 from "@/assets/products/waterpro-stop-check-valve-1077.png";
...
import wpBallValve4000 from "@/assets/products/waterpro-ball-valve-4000.png";
import wpBallValve4001 from "@/assets/products/waterpro-ball-valve-4001.png";
import wpBallValve4002 from "@/assets/products/waterpro-ball-valve-4002.png";
import wpBallValve4003 from "@/assets/products/waterpro-ball-valve-4003.png";
import wpBallValve4004 from "@/assets/products/waterpro-ball-valve-4004.png";
import wpCompressionFitting4078 from "@/assets/products/waterpro-compression-fitting-4078.png";
import wpBallValve4079 from "@/assets/products/waterpro-ball-valve-4079.png";
...
import wpPumpConnector4076 from "@/assets/products/waterpro-pump-connector-4076.png";
import wpCheckValve4077 from "@/assets/products/waterpro-check-valve-4077.png";
...
import wpCoupling4052 from "@/assets/products/waterpro-coupling-4052.png";
import wpElbow4053 from "@/assets/products/waterpro-elbow-4053.png";
...
import wpPressTee4065 from "@/assets/products/waterpro-press-tee-4065.png";
import wpPressTeeReducing4066 from "@/assets/products/waterpro-press-tee-reducing-4066.png";
...
import wpFlexGasHose4209 from "@/assets/products/waterpro-flex-gas-hose-4209.png";
...
import wpCabinet5018 from "@/assets/products/waterpro-cabinet-5018.png";
import wpHydroCollector5009 from "@/assets/products/waterpro-hydro-collector-5009.png";
...
import wpPressTool6030 from "@/assets/products/waterpro-press-tool-6030.png";
import wpPressTool6031 from "@/assets/products/waterpro-press-tool-6031.png";
...
import wpFemaleCoupling7015 from "@/assets/products/waterpro-press-female-coupling-7015.png";
import wpMaleUnion7018 from "@/assets/products/waterpro-press-male-union-7018.png";
...
import wpPressTool5046 from "@/assets/products/waterpro-press-tool-5046.png";
import wpPressJaws7550 from "@/assets/products/waterpro-press-jaws-7550.png";
import wpSs304Pipe7500 from "@/assets/products/waterpro-ss304-pipe-7500.png";
import wpSs304Coupling7505 from "@/assets/products/waterpro-ss304-coupling-7505.png";
import wpSs304ReducingCoupling7506 from "@/assets/products/waterpro-ss304-reducing-coupling-7506.png";
import wpSs304AdjCoupling7508 from "@/assets/products/waterpro-ss304-adjustable-coupling-7508.png";
import wpSs304ReducingCouplingB7507 from "@/assets/products/waterpro-ss304-reducing-coupling-b-7507.png";
...
import wpSs304FemaleCoupling7517 from "@/assets/products/waterpro-ss304-female-coupling-7517.png";
import wpSs304FemaleUnion7521 from "@/assets/products/waterpro-ss304-female-union-7521.png";
...
export const products: Product[] = [
  ...
  },
  {
    ...
    specs: [
      { label: { uz: "Turi", ru: "Тип" }, value: "PP-R PN16 ХВС (4м/штук)" },
      { label: { uz: "Ø20×2.8", ru: "Ø20×2.8" }, value: "140m / 101601" },
      { label: { uz: "Ø25×3.5", ru: "Ø25×3.5" }, value: "100m / 101602" },
      { label: { uz: "Ø32×4.4", ru: "Ø32×4.4" }, value: "60m / 101603" },
      { label: { uz: "Ø40×4.5", ru: "Ø40×4.5" }, value: "40m / 101604" },
      { label: { uz: "Ø50×5.6", ru: "Ø50×5.6" }, value: "24m / 101605" },
      { label: { uz: "Ø63×7.1", ru: "Ø63×7.1" }, value: "16m / 101606" },
      { label: { uz: "Ø75×8.4", ru: "Ø75×8.4" }, value: "12m / 101607" },
      { label: { uz: "Ø90×10.1", ru: "Ø90×10.1" }, value: "8m / 101608" },
      { label: { uz: "Ø110×12.3", ru: "Ø110×12.3" }, value: "8m / 101609" },
      { label: { uz: "Kod", ru: "Код" }, value: "1016" }
    ]
  },
  {
    ...
    specs: [
      { label: { uz: "Turi", ru: "Тип" }, value: "PP-R PN20 ГВС (4м/штук)" },
      { label: { uz: "Ø20×2.8", ru: "Ø20×2.8" }, value: "140m / 101701" },
      { label: { uz: "Ø25×3.5", ru: "Ø25×3.5" }, value: "100m / 101702" },
      { label: { uz: "Ø32×4.4", ru: "Ø32×4.4" }, value: "60m / 101703" },
      { label: { uz: "Ø40×5.5", ru: "Ø40×5.5" }, value: "40m / 101704" },
      { label: { uz: "Ø50×6.9", ru: "Ø50×6.9" }, value: "24m / 101705" },
      { label: { uz: "Ø63×8.7", ru: "Ø63×8.7" }, value: "16m / 101706" },
      { label: { uz: "Ø75×10.1", ru: "Ø75×10.1" }, value: "12m / 101707" },
      { label: { uz: "Ø90×12.3", ru: "Ø90×12.3" }, value: "8m / 101708" },
      { label: { uz: "Ø110×15.1", ru: "Ø110×15.1" }, value: "8m / 101709" },
  ...
  {
    id: "waterpro-thermostat-5030",
    name: "WaterPRO Термостат комнатный 5030",
    category: "waterpro",
    images: [wpThermostat5030],
    description: {
      uz: "WaterPRO xonali termostat (wifi). Oq korpus, LCD displey.",
      ru: "Комнатный термостат WaterPRO (wifi). Белый корпус, LCD дисплей."
    },
    specs: [
      { label: { uz: "wifi", ru: "wifi" }, value: "100 / 503001" }
    ]
  },
  {
    id: "waterpro-thermostat-5031",
    name: "WaterPRO Термостат комнатный 5031",
    category: "waterpro",
    images: [wpThermostat5031],
    description: {
      uz: "WaterPRO xonali termostat (wifi). Qora korpus, yoritilgan LCD displey.",
      ru: "Комнатный термостат WaterPRO (wifi). Чёрный корпус, LCD дисплей с подсветкой."
    },
    specs: [
      { label: { uz: "wifi", ru: "wifi" }, value: "100 / 503101" }
    ]
  },
  {
    id: "waterpro-thermostat-5032",
    name: "WaterPRO Термостат комнатный 5032",
    category: "waterpro",
    images: [wpThermostat5032],
    description: {
      uz: "WaterPRO xonali termostat (wifi). Oq korpus, sensorli tugmalar.",
      ru: "Комнатный термостат WaterPRO (wifi). Белый корпус, сенсорные кнопки."
    },
    specs: [
      { label: { uz: "wifi", ru: "wifi" }, value: "100 / 503201" }
    ]
  },
  {
    id: "waterpro-thermostat-5033",
    name: "WaterPRO Термостат комнатный 5033",
    category: "waterpro",
    images: [wpThermostat5033],
    description: {
      uz: "WaterPRO xonali termostat (wifi). Rangli displey, sensorli boshqaruv.",
      ru: "Комнатный термостат WaterPRO (wifi). Цветной дисплей, сенсорное управление."
    },
    specs: [
  ...
  },
  {
    ...
    images: [shimgeCpm750],
    description: {
      uz: "SHIMGE CPM750 markazdan qochma nasosi turli sharoitlarda toza suv va kimyoviy jihatdan agressiv bo'lmagan suyuqliklarni haydash uchun mo'ljallangan kuchli va ishonchli qurilma. 750 Vt (1 ot kuchi) quvvat nasosning yuqori ish qobiliyati va samarali ishlashini ta'minlaydi. Imkoniyati daqiqada 75 litrgacha (soatiga 4.5 kubometr) - bu nasos bir soat ishlaganda 4.5 kubometrgacha suv haydashi mumkinligini anglatadi. Maksimal napor 50 metr bo'lib, bu nasosni suvni sezilarli balandliklarga yoki uzoq masofalarga yetkazib berish uchun ishlatishga imkon beradi. Maksimal so'rish chuqurligi 9 metrgacha, bu chuqur quduqlar va rezervuarlardan suvni ko'tarish uchun javob beradi. Xususiy uylar va kottejlar uchun suv ta'minoti, bog'lar va polizlarni sug'orish, bosim oshirish tizimlari, toza suvni haydash talab qilinadigan sanoat va qishloq xo'jaligi ehtiyojlari uchun ideal. Nasos korpusi yuqori sifatli choyandan yasalgan bo'lib, chidamlilik va korroziyaga chidamlilikni ta'minlaydi. Ishchi g'ildirak latundan yasalgan, bu nasosning chidamliligi va ishonchliligini oshiradi. Nasos vali zanglamaydigan po'latdan yasalgan bo'lib, korroziyaga qo'shimcha chidamlilik beradi. Nasos qurilmaning ishlash muddatini uzaytiradigan haddan tashqari qizish va ortiqcha yuklardan himoya bilan jihozlangan ishonchli elektr dvigateliga ega. O'rtacha energiya sarfi bilan yuqori ish qobiliyati, kirish bosimining o'zgarishi bilan ham barqaror napor va ish qobiliyati, haddan tashqari qizib ketmasdan uzluksiz ishlash imkoniyati. Ixcham o'lchamlari va engil vazni o'rnatish va tashishni osonlashtiradi. Qulay dizayn va asosiy komponentlarning ochiqligiga qarab oddiy montaj va texnik xizmat ko'rsatish. Nasos nisbatan jim ishlaydi, bu esa uni turar-joy hududlarida ishlatish uchun qulay qiladi.",
      ru: "Центробежный насос SHIMGE CPM750 - это мощное и надежное устройство, предназначенное для перекачивания чистой воды и других химически неагрессивных жидкостей в различных условиях. Мощность 750 Вт (1 л.с.) обеспечивает высокую производительность и эффективную работу насоса. Производительность до 75 литров в минуту (4.5 кубометра в час) означает, что насос способен перекачивать до 4.5 кубометров воды за один час работы. Максимальный напор 50 метров позволяет использовать насос для подачи воды на значительные высоты или на дальние расстояния. Максимальная глубина всасывания до 9 метров делает его подходящим для подъема воды из глубоких колодцев и резервуаров. Идеально подходит для водоснабжения частных домов и коттеджей, полива и орошения садов и огородов, систем повышения давления, промышленных и сельскохозяйственных нужд, где требуется перекачка чистой воды. Корпус насоса изготовлен из высококачественного чугуна, что обеспечивает долговечность и устойчивость к коррозии. Рабочее колесо выполнено из латуни, что также повышает долговечность и надежность насоса. Вал насоса изготовлен из нержавеющей стали, что обеспечивает дополнительную устойчивость к коррозии. Насос оснащен надежным электродвигателем с защитой от перегрева и перегрузок, что продлевает срок службы устройства. Высокая производительность при умеренном энергопотреблении, стабильный напор и производительность даже при колебаниях давления на входе, способность работать в непрерывном режиме без перегрева. Компактные размеры и легкий вес облегчают установку и транспортировку насоса. Простой монтаж и обслуживание благодаря удобной конструкции и доступности ключевых компонентов. Насос работает относительно тихо, что делает его удобным для использования в жилых зонах."
    },
    specs: [
      { label: { uz: "Ishlab chiqaruvchi", ru: "Бренд" }, value: "SHIMGE" },
      { label: { uz: "Model", ru: "Модель" }, value: "CPM750" },
      { label: { uz: "Turi", ru: "Тип" }, value: "Markazdan qochma / Центробежный" },
      { label: { uz: "Quvvat", ru: "Мощность" }, value: "750 W (720 W ish rejimida / в рабочем режиме)" },
      { label: { uz: "Maksimal napor", ru: "Максимальный напор" }, value: "50 m" },
      { label: { uz: "Maksimal oqim", ru: "Производительность" }, value: "75 l/daqiqa (4.5 m³/soat) / л/мин (м³/час)" },
      { label: { uz: "So'rish balandligi", ru: "Глубина всасывания" }, value: "9 m gacha / до 9 м" },
      { label: { uz: "Kuchlanish", ru: "Напряжение" }, value: "220-240 V / 50 Hz" },
      { label: { uz: "Material", ru: "Материал корпуса" }, value: "Choyan / Чугун" },
      { label: { uz: "Ishchi g'ildirak", ru: "Рабочее колесо" }, value: "Latun / Латунь" },
      { label: { uz: "Vali", ru: "Вал двигателя" }, value: "Zanglamaydigan po'lat / Нержавеющая сталь" },
      { label: { uz: "Mamlakat", ru: "Страна производитель" }, value: "Xitoy / Китай" },
      { label: { uz: "Kafolat", ru: "Гарантия" }, value: "24 oy / месяца" }
  ...
  },
  {
    ...
    images: [shimgeCpm170],
    description: {
      uz: "SHIMGE CPM170 kuchli markazdan qochma nasos 1100 Vt quvvat bilan. Yuqori samaradorlik va ishonchlilik bilan ajralib turadi. Tashqi o'rnatish uchun mo'ljallangan, gorizontal joylashuv. Xususiy uylar, kottejlar, fermer xo'jaliklari va sanoat ob'ektlarida toza suvni haydash uchun mukammal yechim. 44 metr maksimal napor yuqori balandliklarga yoki uzoq masofalarga suv etkazib berishga imkon beradi. 7.8 kubometr/soat o'tkazish qobiliyati katta hajmdagi suv ta'minoti tizimlarida samarali ishlashini ta'minlaydi. 8 metrgacha so'rish chuqurligi quduqlar va rezervuarlardan suvni ko'tarishga imkon beradi. 1¼ dyuymli kirish va chiqish diametri katta miqdordagi suvni haydash uchun yetarli. Nasos korpusi yuqori sifatli choyandan yasalgan bo'lib, uzoq xizmat muddati va korroziyaga chidamlilikni ta'minlaydi. Markazdan qochma mexanizm barqaror va samarali ishlashni kafolatlaydi. 40°C gacha suyuqlik va muhit haroratida ishlash imkoniyati. 220/230 V standart kuchlanish bilan ishlaydi. 20 kg vazn nisbatan oson o'rnatish va tashish imkoniyatini beradi. Bog' va polizlarni sug'orish, uylar uchun suv ta'minoti, bosim oshirish tizimlari, sanoat va qishloq xo'jaligi ob'ektlarida foydalanish uchun ideal. SHIMGE brendi 30 yildan ortiq tajribaga ega, dunyoda tan olingan ishonchli ishlab chiqaruvchi.",
      ru: "SHIMGE CPM170 - мощный центробежный насос мощностью 1100 Вт. Отличается высокой производительностью и надежностью. Предназначен для наружной установки, горизонтальное расположение. Идеальное решение для перекачки чистой воды в частных домах, коттеджах, фермерских хозяйствах и промышленных объектах. Максимальный напор 44 метра позволяет подавать воду на значительные высоты или большие расстояния. Пропускная способность 7.8 кубометров/час обеспечивает эффективную работу в системах водоснабжения большого объема. Глубина всасывания до 8 метров позволяет поднимать воду из колодцев и резервуаров. Диаметр входа и выхода 1¼ дюйма достаточен для перекачки больших объемов воды. Корпус насоса изготовлен из высококачественного чугуна, что обеспечивает долгий срок службы и устойчивость к коррозии. Центробежный механизм гарантирует стабильную и эффективную работу. Возможность работы при температуре жидкости и окружающей среды до 40°C. Работает от стандартного напряжения 220/230 В. Вес 20 кг позволяет относительно легко устанавливать и транспортировать насос. Идеально подходит для полива садов и огородов, водоснабжения домов, систем повышения давления, использования на промышленных и сельскохозяйственных объектах. Бренд SHIMGE имеет опыт более 30 лет, признанный надежный производитель в мире."
    },
    specs: [
      { label: { uz: "Ishlab chiqaruvchi", ru: "Бренд" }, value: "SHIMGE" },
      { label: { uz: "Model", ru: "Модель" }, value: "CPM170" },
      { label: { uz: "Turi", ru: "Тип" }, value: "Tashqari joylanuvchi / Наружный" },
      { label: { uz: "Nasos mexanizmi", ru: "Механизм насоса" }, value: "Markazdan qochma / Центробежный" },
      { label: { uz: "Quvvat", ru: "Мощность" }, value: "1100 W" },
      { label: { uz: "Maksimal napor", ru: "Максимальный напор" }, value: "44 m" },
      ...
      { label: { uz: "Kirish/Chiqish diametri", ru: "Диаметр входа/выхода" }, value: "1¼\" (31.75 mm)" },
      { label: { uz: "O'rnatish", ru: "Установка насоса" }, value: "Gorizontal / Горизонтальная" },
      { label: { uz: "Suv tozaligi", ru: "Чистота воды" }, value: "Toza suv / Чистая вода" },
      { label: { uz: "Suyuqlik harorati", ru: "Температура жидкости" }, value: "+40°C gacha / до +40°C" },
  ...
  {
    id: "shimge-sgt32-160-3",
    name: "SHIMGE SGT32-160/3",
    category: "shimge",
    images: [shimgeSgt32160_3],
    description: {
      uz: "SHIMGE SGT32-160/3 markazdan qochma nasosi abraziv zarralar bo'lmagan suv yoki suvga o'xshash xususiyatlarga ega boshqa suyuqliklarni ko'chirish uchun mo'ljallangan. Sanoat va shahar suv ta'minoti, baland binolarda bosimni oshirish, yong'inga qarshi himoya tizimlarida keng qo'llaniladi. Yuqori mustahkamlikdagi konstruksiya xavfsiz va ishonchli. Dvigatel va nasos bir xil valga ega, bu qurilmani ixcham va samarali qiladi. Mexanik yuza zichlagichi: kremniy karbid / grafit / NBR rezina uzoq muddatli xizmat ko'rsatishni ta'minlaydi. Yangi gidravlik qism samarali va energiyani tejaydi. 2-qutbli asinxron dvigatel, mis lasan, to'liq yopiq ventilyator sovutish tizimi bilan, uzluksiz ishlash uchun mo'ljallangan. Qo'shimcha opsiyalar: F-sinf dvigatel, NSK podshipniklar, payvandlangan val. Yuqori sifatli materiallar va texnologiyalar mahsulotning uzoq muddatli ishlashini kafolatlaydi. Professional ta'mirlash va texnik xizmat ko'rsatish oson va qulay. SHIMGE brendi - dunyo miqyosidagi ishonchlilik va yuqori samaradorlik belgisi.",
      ru: "Центробежный насос SHIMGE SGT32-160/3 подходит для перекачки воды без абразивных частиц или другой жидкости, свойства которой схожи с водой. Широко используется в промышленном и городском водоснабжении, усилении напора в высотных зданиях, системе противопожарной защиты и др. Высокопрочная конструкция, безопасная и надежная. Двигатель и насос имеют один и тот же вал, что делает устройство компактным и эффективным. Механическое торцевое уплотнение: карбид кремния / графит / резина NBR обеспечивает долговременную эксплуатацию. Совершенно новая гидравлическая часть, эффективная и энергосберегающая. 2-полюсный асинхронный двигатель, медная катушка, полностью закрытое вентиляторное охлаждение, рассчитан на непрерывную работу. Опционально доступны: двигатель F-класса, подшипники NSK, сварной вал. Высококачественные материалы и технологии гарантируют долговечную работу изделия. Профессиональный ремонт и техническое обслуживание просты и удобны. Бренд SHIMGE - знак мирового класса надежности и высокой эффективности."
    },
    specs: [
      { label: { uz: "Ishlab chiqaruvchi", ru: "Бренд" }, value: "SHIMGE" },
      { label: { uz: "Model", ru: "Модель" }, value: "SGT32-160/3" },
      { label: { uz: "Turi", ru: "Тип" }, value: "Markazdan qochma / Центробежный" },
      { label: { uz: "Quvvat", ru: "Мощность" }, value: "3 kW" },
      { label: { uz: "Teshik diametri", ru: "Диаметр отверстия" }, value: "50/32 mm" },
      { label: { uz: "Oqim", ru: "Поток" }, value: "35 m" },
      { label: { uz: "Kuchlanish", ru: "Напряжение" }, value: "380 V" },
      { label: { uz: "O'tkazish qobiliyati", ru: "Производительность" }, value: "21 m³/soat / м³/ч" },
  ...
  {
    id: "shimge-sgt40-160-4",
    name: "SHIMGE SGT40-160/4",
    category: "shimge",
    images: [shimgeSgt40160_4],
    description: {
      uz: "SHIMGE SGT40-160/4 markazdan qochma nasosi abraziv zarralar bo'lmagan suv yoki suvga o'xshash xususiyatlarga ega boshqa suyuqliklarni ko'chirish uchun mo'ljallangan. Sanoat va shahar suv ta'minoti, baland binolarda bosimni oshirish, yong'inga qarshi himoya tizimlarida keng qo'llaniladi. Yuqori mustahkamlikdagi konstruksiya xavfsiz va ishonchli. Dvigatel va nasos bir xil valga ega, bu qurilmani ixcham va samarali qiladi. Mexanik yuza zichlagichi: kremniy karbid / grafit / NBR rezina uzoq muddatli xizmat ko'rsatishni ta'minlaydi. Yangi gidravlik qism samarali va energiyani tejaydi. 2-qutbli asinxron dvigatel, mis lasan, to'liq yopiq ventilyator sovutish tizimi bilan, uzluksiz ishlash uchun mo'ljallangan. Qo'shimcha opsiyalar: F-sinf dvigatel, NSK podshipniklar, payvandlangan val. 4 kW quvvat va 30 m³/soat o'tkazish qobiliyati katta ob'ektlar uchun ideal. 65/40 mm teshik diametri katta quvur tizimlariga ulanish imkonini beradi. SHIMGE brendi - sanoat standartlari va yuqori ishonchlilik.",
      ru: "Центробежный насос SHIMGE SGT40-160/4 подходит для перекачки воды без абразивных частиц или другой жидкости, свойства которой схожи с водой. Широко используется в промышленном и городском водоснабжении, усилении напора в высотных зданиях, системе противопожарной защиты и др. Высокопрочная конструкция, безопасная и надежная. Двигатель и насос имеют один и тот же вал, что делает устройство компактным и эффективным. Механическое торцевое уплотнение: карбид кремния / графит / резина NBR обеспечивает долговременную эксплуатацию. Совершенно новая гидравлическая часть, эффективная и энергосберегающая. 2-полюсный асинхронный двигатель, медная катушка, полностью закрытое вентиляторное охлаждение, рассчитан на непрерывную работу. Опционально доступны: двигатель F-класса, подшипники NSK, сварной вал. Мощность 4 кВт и производительность 30 м³/час идеальны для крупных объектов. Диаметр отверстия 65/40 мм позволяет подключаться к крупным трубопроводным системам. Бренд SHIMGE - промышленные стандарты и высокая надежность."
    },
    specs: [
      { label: { uz: "Ishlab chiqaruvchi", ru: "Бренд" }, value: "SHIMGE" },
      { label: { uz: "Model", ru: "Модель" }, value: "SGT40-160/4" },
      { label: { uz: "Turi", ru: "Тип" }, value: "Markazdan qochma / Центробежный" },
      { label: { uz: "Quvvat", ru: "Мощность" }, value: "4 kW" },
      { label: { uz: "Teshik diametri", ru: "Диаметр отверстия" }, value: "65/40 mm" },
      { label: { uz: "Oqim", ru: "Поток" }, value: "36 m" },
      { label: { uz: "Kuchlanish", ru: "Напряжение" }, value: "380 V" },
      { label: { uz: "O'tkazish qobiliyati", ru: "Производительность" }, value: "30 m³/soat / м³/ч" },
      { label: { uz: "Dvigatel", ru: "Двигатель" }, value: "2-qutbli asinxron, mis lasan / 2-полюсный асинхронный, медная катушка" },
      { label: { uz: "Sovutish", ru: "Охлаждение" }, value: "To'liq yopiq ventilyator / Полностью закрытое вентиляторное" },
      { label: { uz: "Mamlakat", ru: "Страна производитель" }, value: "Xitoy / Китай" }
    ]
  ...
  {
    id: "shimge-sgt40-200-5.5",
    name: "SHIMGE SGT40-200/5.5",
    category: "shimge",
    images: [shimgeSgt40200_5_5],
    description: {
      uz: "SHIMGE SGT40-200/5.5 markazdan qochma nasosi abraziv zarralar bo'lmagan suv yoki suvga o'xshash xususiyatlarga ega boshqa suyuqliklarni ko'chirish uchun mo'ljallangan. Sanoat va shahar suv ta'minoti, baland binolarda bosimni oshirish, yong'inga qarshi himoya tizimlarida keng qo'llaniladi. Yuqori mustahkamlikdagi konstruksiya xavfsiz va ishonchli. Dvigatel va nasos bir xil valga ega, bu qurilmani ixcham va samarali qiladi. Mexanik yuza zichlagichi: kremniy karbid / grafit / NBR rezina uzoq muddatli xizmat ko'rsatishni ta'minlaydi. Yangi gidravlik qism samarali va energiyani tejaydi. 2-qutbli asinxron dvigatel, mis lasan, to'liq yopiq ventilyator sovutish tizimi bilan, uzluksiz ishlash uchun mo'ljallangan. Qo'shimcha opsiyalar: F-sinf dvigatel, NSK podshipniklar, payvandlangan val. 5.5 kW quvvat va 39 m³/soat o'tkazish qobiliyati eng yuqori talab qilinadigan ishlar uchun. 42 metr oqim yuqori balandliklar va uzoq masofalar uchun ideal. Sanoat ob'ektlari va katta binolar uchun professional yechim.",
      ru: "Центробежный насос SHIMGE SGT40-200/5.5 подходит для перекачки воды без абразивных частиц или другой жидкости, свойства которой схожи с водой. Широко используется в промышленном и городском водоснабжении, усилении напора в высотных зданиях, системе противопожарной защиты и др. Высокопрочная конструкция, безопасная и надежная. Двигатель и насос имеют один и тот же вал, что делает устройство компактным и эффективным. Механическое торцевое уплотнение: карбид кремния / графит / резина NBR обеспечивает долговременную эксплуатацию. Совершенно новая гидравлическая часть, эффективная и энергосберегающая. 2-полюсный асинхронный двигатель, медная катушка, полностью закрытое вентиляторное охлаждение, рассчитан на непрерывную работу. Опционально доступны: двигатель F-класса, подшипники NSK, сварной вал. Мощность 5.5 кВт и производительность 39 м³/час для самых требовательных задач. Поток 42 метра идеален для больших высот и расстояний. Профессиональное решение для промышленных объектов и крупных зданий."
    },
    specs: [
      { label: { uz: "Ishlab chiqaruvchi", ru: "Бренд" }, value: "SHIMGE" },
      { label: { uz: "Model", ru: "Модель" }, value: "SGT40-200/5.5" },
      { label: { uz: "Turi", ru: "Тип" }, value: "Markazdan qochma / Центробежный" },
      { label: { uz: "Quvvat", ru: "Мощность" }, value: "5.5 kW" },
      { label: { uz: "Teshik diametri", ru: "Диаметр отверстия" }, value: "65/40 mm" },
      { label: { uz: "Oqim", ru: "Поток" }, value: "42 m" },
      { label: { uz: "Kuchlanish", ru: "Напряжение" }, value: "380 V" },
  ...
  },
  {
    ...
    name: "SHIMGE SHFm5BM",
    category: "shimge",
    images: [shimgeShfm5bm],
    description: {
      uz: "SHIMGE SHFm5BM markazdan qochma nasosi abraziv zarralar bo'lmagan suv yoki suvga o'xshash xususiyatlarga ega boshqa suyuqliklarni ko'chirish uchun mo'ljallangan. Bog' sug'orish, sabzavotchilik, issiqxona suv ta'minoti, chorvachilikda suv ta'minoti va suv chiqarish, turli o'g'it berish uskunalarida keng foydalaniladi. 7 metrgacha so'rish chuqurligi. Suyuqlik harorati +40°C gacha, atrof-muhit harorati +40°C gacha ishlash imkoniyati. Maksimal ish bosimi 3 bar. Kuchlanish o'zgarishlari nominal qiymatdan 10% dan oshmasligi kerak. pH darajasi 6.5 dan 8.5 gacha. Katta oqim va yuqori samaradorlik bilan. Ixcham konstruksiya, oson o'rnatish. 1.1 kW quvvat va 36 m³/soat o'tkazish qobiliyati yuqori unumdorlikni ta'minlaydi. 50 mm chiqish teshigi diametri katta quvur tizimlariga ulanish uchun qulay. Barcha asosiy qismlar yuqori sifatli materiallardan yasalgan bo'lib, uzoq xizmat muddatini ta'minlaydi. Issiqxonalar, fermer xo'jaliklari, bog'lar va qishloq xo'jaligi ob'ektlarida ishlatish uchun mukammal. Energiya tejamkor va samarali ishlash. 6 oy kafolat bilan.",
      ru: "Центробежный насос SHIMGE SHFm5BM подходит для переноса воды без абразивных частиц или другой жидкости, свойства которой похожи на воду. Широко используется в садовой ирригации, овощеводстве, тепличном водоснабжении, водоснабжении и водоотведении в животноводстве, различном оборудовании для внесения удобрений и т.д. Всасывающая головка до 7 метров. Температура жидкости до +40°С, температура окружающей среды до +40°С. Максимальное рабочее давление 3 бар. Колебания напряжения не должны превышать 10% от номинального значения. pH от 6.5 до 8.5. Большой поток и высокая эффективность. Компактная структура, простота установки. Мощность 1.1 кВт и пропускная способность 36 м³/час обеспечивают высокую производительность. Диаметр выходного отверстия 50 мм удобен для подключения к крупным трубопроводным системам. Все основные детали изготовлены из высококачественных материалов, что обеспечивает длительный срок службы. Идеально подходит для использования в теплицах, фермерских хозяйствах, садах и сельскохозяйственных объектах. Энергосберегающая и эффективная работа. Гарантия 6 месяцев."
    },
    specs: [
      { label: { uz: "Ishlab chiqaruvchi", ru: "Бренд" }, value: "SHIMGE" },
      { label: { uz: "Model", ru: "Модель" }, value: "SHFm5BM" },
      { label: { uz: "Turi", ru: "Тип" }, value: "Markazdan qochma / Центробежный" },
      { label: { uz: "Kategoriya", ru: "Категория" }, value: "Markazdan qochma nasoslar / Центробежные насосы" },
      { label: { uz: "Quvvat", ru: "Мощность" }, value: "1.1 kW (1100 W)" },
      { label: { uz: "O'tkazish qobiliyati", ru: "Пропускная способность" }, value: "36 m³/soat / м³/час" },
  ...
  },
  {
    ...
    images: [shimgeShfm6a],
    description: {
      uz: "SHIMGE SHFm6A markazdan qochma nasosi abraziv zarralar bo'lmagan suv yoki suvga o'xshash xususiyatlarga ega boshqa suyuqliklarni ko'chirish uchun mo'ljallangan. Bog' sug'orish, sabzavotchilik, issiqxona suv ta'minoti, chorvachilikda suv ta'minoti va suv chiqarish, turli o'g'it berish uskunalarida keng foydalaniladi. 7 metrgacha so'rish chuqurligi. Suyuqlik harorati +40°C gacha, atrof-muhit harorati +40°C gacha ishlash imkoniyati. Maksimal ish bosimi 3 bar. Kuchlanish o'zgarishlari nominal qiymatdan 10% dan oshmasligi kerak. pH darajasi 6.5 dan 8.5 gacha. Katta oqim va yuqori samaradorlik bilan. Ixcham konstruksiya, oson o'rnatish. 6 kW yuqori quvvat katta hajmdagi suv ta'minoti uchun. 78 m³/soat katta o'tkazish qobiliyati sanoat va fermer xo'jaliklari uchun ideal. 80 mm chiqish teshigi diametri yirik quvur tizimlariga ulanish uchun. Barcha asosiy qismlar yuqori sifatli materiallardan yasalgan. Katta issiqxonalar, fermer xo'jaliklari, intensiv sug'orish tizimlari uchun professional yechim. 6 oy kafolat.",
      ru: "Центробежный насос SHIMGE SHFm6A подходит для переноса воды без абразивных частиц или другой жидкости, свойства которой похожи на воду. Широко используется в садовой ирригации, овощеводстве, тепличном водоснабжении, водоснабжении и водоотведении в животноводстве, различном оборудовании для внесения удобрений и т.д. Всасывающая головка до 7 метров. Температура жидкости до +40°С, температура окружающей среды до +40°С. Максимальное рабочее давление 3 бар. Колебания напряжения не должны превышать 10% от номинального значения. pH от 6.5 до 8.5. Большой поток и высокая эффективность. Компактная структура, простота установки. Высокая мощность 6 кВт для водоснабжения больших объемов. Большая пропускная способность 78 м³/час идеальна для промышленности и фермерских хозяйств. Диаметр выходного отверстия 80 мм для подключения к крупным трубопроводным системам. Все основные детали изготовлены из высококачественных материалов. Профессиональное решение для крупных теплиц, фермерских хозяйств, интенсивных систем орошения. Гарантия 6 месяцев."
    },
    specs: [
      { label: { uz: "Ishlab chiqaruvchi", ru: "Бренд" }, value: "SHIMGE" },
      { label: { uz: "Model", ru: "Модель" }, value: "SHFm6A" },
      { label: { uz: "Turi", ru: "Тип" }, value: "Markazdan qochma / Центробежный" },
      { label: { uz: "Kategoriya", ru: "Категория" }, value: "Markazdan qochma nasoslar / Центробежные насосы" },
      { label: { uz: "Quvvat", ru: "Мощность" }, value: "6 kW (6000 W)" },
      { label: { uz: "O'tkazish qobiliyati", ru: "Пропускная способность" }, value: "78 m³/soat / м³/час" },
      { label: { uz: "Chiqish diametri", ru: "Диаметр резьбы выходящего отверстия" }, value: "80 mm" },
      { label: { uz: "So'rish chuqurligi", ru: "Всасывающая головка" }, value: "7 m gacha / до 7 м" },
      { label: { uz: "Maksimal bosim", ru: "Максимальное рабочее давление" }, value: "3 bar" },
      { label: { uz: "Suyuqlik harorati", ru: "Температура жидкости" }, value: "+40°C gacha / до +40°C" },
      { label: { uz: "Mamlakat", ru: "Страна бренда" }, value: "Xitoy / Китай" },
  ...
  },
  {
    ...
    images: [shimgeShfm6b],
    description: {
      uz: "SHIMGE SHFm6B markazdan qochma nasosi suv havzalari, sug'orish, quduqlar uchun mo'ljallangan. Toza suvni quyish uchun yuqori samarali qurilma. 1500 Vt (1.5 kW) quvvat. 14.7 metr maksimal suv napori. 7 metrgacha maksimal so'rish chuqurligi. 72 m³/soat (1200 litr/daqiqa) yuqori o'tkazish qobiliyati. Toza suv sifati uchun mo'ljallangan. Maksimal ish harorati 40°C. Quyma temir korpus va ishchi g'ildirak yuqori chidamlilikni ta'minlaydi. Mis stator va zanglamaydigan po'lat val uzoq xizmat muddatini kafolatlaydi. 1.3 metr kabel uzunligi. Ipli ulanish turi, 3 dyuymli (76mm) ulanish diametri. 220V kuchlanish. 31 kg og'irlik. Suv havzalari, sug'orish tizimlari va quduqlar uchun ideal. Yuqori o'tkazish qobiliyati va ishonchlilik. SHIMGE brendi - Xitoyda ro'yxatdan o'tgan, yuqori sifat standartlari.",
      ru: "Центробежный насос SHIMGE SHFm6B предназначен для водоёмов, полива, колодцев. Высокоэффективное устройство для перекачивания чистой воды. Мощность 1500 Вт (1.5 кВт). Максимальный напор воды 14.7 метров. Максимальная глубина всасывания 7 метров. Высокая производительность 72 м³/ч (1200 л/мин). Предназначен для чистой воды. Максимальная рабочая температура 40°C. Корпус и рабочее колесо из чугуна обеспечивают высокую прочность. Статор из меди и вал из нержавеющей стали гарантируют длительный срок службы. Длина кабеля 1.3 метра. Тип подключения резьба, диаметр подключения 3 дюйма (76мм). Напряжение 220В. Вес 31 кг. Идеально для водоёмов, систем полива и колодцев. Высокая производительность и надежность. Бренд SHIMGE - зарегистрирован в Китае, стандарты высокого качества."
    },
    specs: [
      { label: { uz: "Ishlab chiqaruvchi", ru: "Бренд" }, value: "SHIMGE" },
      { label: { uz: "Model", ru: "Модель" }, value: "SHFm6B" },
      { label: { uz: "Turi", ru: "Тип" }, value: "Markazdan qochma / Центробежный" },
      { label: { uz: "Qo'llanilishi", ru: "Сфера применения" }, value: "Suv havzalari, sug'orish, quduqlar / Для водоёмов, полива, колодца" },
      { label: { uz: "Quvvat", ru: "Мощность" }, value: "1500 W (1.5 kW)" },
      { label: { uz: "Maksimal napor", ru: "Максимальный напор воды" }, value: "14.7 m" },
      { label: { uz: "So'rish chuqurligi", ru: "Максимальная глубина всасывания" }, value: "7 m" },
      { label: { uz: "O'tkazish qobiliyati", ru: "Производительность" }, value: "72 m³/soat (1200 L/min) / м³/ч (л/мин)" },
      { label: { uz: "Suv sifati", ru: "Качество воды" }, value: "Toza / Чистая" },
      { label: { uz: "Maksimal harorat", ru: "Макс. рабочая температура" }, value: "40°C" },
      { label: { uz: "Korpus materiali", ru: "Материал корпуса" }, value: "Quyma temir / Чугун" },
      { label: { uz: "Ishchi g'ildirak", ru: "Материал рабочего колеса" }, value: "Quyma temir / Чугун" },
      { label: { uz: "Stator", ru: "Материал статора" }, value: "Mis / Медь" },
      { label: { uz: "Val", ru: "Материал вала" }, value: "Zanglamaydigan po'lat / Нержавеющая сталь" },
      { label: { uz: "Ulanish turi", ru: "Тип подключения" }, value: "Ipli / Резьба" },
      { label: { uz: "Ulanish diametri", ru: "Диаметр подключения" }, value: "3\" (76 mm)" },
  ...
  {
    id: "shimge-3sem1.8-27-0.75t",
    name: "SHIMGE 3SEm1.8/27-0.75T",
    category: "shimge",
    images: [shimge3sem18_27_075t],
    description: {
      uz: "SHIMGE 3SEm1.8/27-0.75T chuqur quduq uchun suv osti nasosi ichki diametri 85 mm yoki undan katta bo'lgan quduqlar, chuqur quduqlar va ochiq suv havzalaridan toza sovuq suvni quyish uchun mo'ljallangan. Xususiy uylar, kottejlar uchun avtonom suv ta'minoti, bog' uchastkalarini sug'orish, rezervuarlarni suv bilan to'ldirish, kichik fuqarolik, qishloq xo'jaligi va ishlab chiqarish ob'ektlarini suv bilan ta'minlash uchun ideal. Dvigatel oziq-ovqat moyi bilan to'ldirilgan. 'Suzuvchi' ishchi g'ildiraklar qumdan yaxshilangan himoya bilan jihozlangan. Dvigatelning ichki issiqlik himoyasi o'rnatilgan, almashtirish uchun qulay. Nasosning chiqish patrubok guruchdan yasalgan korroziyaga qarshi qoplama bilan. Statik suv sathidan maksimal chuqurlik 70 metr. 2.7 m³/soat maksimal oqim, 115 metr maksimal napor. 0.75 kW quvvat. Faqat vertikal o'rnatish. Zanglamaydigan po'lat korpus va val. Texnopolimerdan yasalgan ishchi g'ildiraklar. 24 oy kafolat.",
      ru: "SHIMGE 3SEm1.8/27-0.75T - глубинный погружной насос для подачи чистой холодной воды из скважин с внутренним диаметром 85 мм или больше, глубоких колодцев, открытых водоемов. Идеально подходит для автономного водоснабжения частных домов, коттеджей, организации полива садовых участков, наполнения водой резервуаров, обеспечения водой малых гражданских, сельскохозяйственных и производственных объектов. Двигатель заполнен пищевым маслом. 'Плавающие' рабочие колеса с улучшенной защитой от песка. Встроенная термозащита двигателя, удобная для замены. Выходной патрубок насоса из латуни с антикоррозионным покрытием. Максимальная глубина от статического уровня воды в скважине 70 метров. Максимальный расход 2.7 м³/ч, максимальный напор 115 метров. Мощность 0.75 кВт. Только вертикальная установка. Корпус и вал из нержавеющей стали. Рабочие колеса из технополимера. Гарантия 24 месяца."
    },
    specs: [
      { label: { uz: "Ishlab chiqaruvchi", ru: "Бренд" }, value: "SHIMGE" },
      { label: { uz: "Model", ru: "Модель" }, value: "3SEm1.8/27-0.75T" },
  ...
  },
  {
    ...
    name: "Очиститель для ПВХ мембран, 1 л",
    category: "penopleks",
    images: [plastfoilPvcCleaner],
    description: {
      uz: "PVX membranalar yuzasini mahalliy tozalash uchun maxsus ishlab chiqilgan tarkib. Kuchaytirilgan va kuchaytrilmagan PVX membranalarning yuzasini issiq havo bilan payvandlashdan oldin (masalan, yamash ta'mirida) yoki suyuq PVX qo'llashdan oldin mahalliy tozalash uchun mo'ljallangan. Asbobni tozalash uchun ham qo'llaniladi.\n\nKonsentrlangan tarkib organik kelib chiqishli (yog'lar, bitum, moy izlari) va polimer tom qurilishi va foydalanishda paydo bo'ladigan noorganik ifloslanishlarni olib tashlaydi.",
      ru: "Специально разработанный состав для локальной очистки поверхности загрязненных и/или старых ПВХ мембран для улучшения адгезии при сварке горячим воздухом, а также очистка инструмента.\n\nКонцентрированный состав удаляет загрязнения как органического происхождения (жиры, битум, следы масла), так и неорганического, возникающие при устройстве и эксплуатации полимерной кровли."
    },
    specs: [
      {
  ...
  // Blesk Water Heaters - Merged by Series
  {
    id: "blesk-concept",
    name: "BLESK Concept/B",
    category: "blesk",
    images: [bleskConcept],
    description: {
      uz: "BLESK Concept/B - zamonaviy elektr suv isitgichlari seriyasi. Ultra yupqa korpus, vertikal va gorizontal o'rnatish imkoniyati. iECO rejimida energiya 24% gacha tejash. ERP B sinfi energiya samaradorligi. Katta ekran - aniq ko'rinish va oddiy boshqaruv. Hola ilovasi orqali masofadan boshqarish. Ti+ emalyali idish uzoq muddatli himoya. Titanli emalyali isitish elementi. 3 yillik kafolat.",
      ru: "BLESK Concept/B - серия современных электрических водонагревателей. Сверхтонкий корпус, вертикальная и горизонтальная установка. В режиме iECO экономия энергии до 24%. Класс энергоэффективности ERP B. Большой экран: четкий обзор и простое управление. Подключение и дистанционное управление с помощью приложения Hola. Резервуар с покрытием из Ti+ эмали для долговечности. Нагревательный элемент из титановой эмали. 3 года гарантии."
    },
    specs: [
      { label: { uz: "Brend", ru: "Бренд" }, value: "BLESK" },
      { label: { uz: "Seriya", ru: "Серия" }, value: "Concept/B" },
  ...
  },
  {
    ...
    images: [bleskFlatx],
    description: {
      uz: "BLESK B/FLATX - ultra yupqa suv isitgichlar seriyasi. Vertikal va gorizontal o'rnatish imkoniyati. Ti+ emalyali idish va isitish elementi. Ag+ antibakterial qoplama bilan bakır kirish klapani. IPX4 himoya darajasi. 3 yillik kafolat.",
      ru: "BLESK B/FLATX - серия сверхтонких водонагревателей. Вертикальная и горизонтальная установка. Резервуар и нагревательный элемент с Ti+ эмалью. Впускной клапан из меди с антибактериальным покрытием Ag+. Водонепроницаемость IPX4. 3 года гарантии."
    },
    specs: [
      { label: { uz: "Brend", ru: "Бренд" }, value: "BLESK" },
      { label: { uz: "Seriya", ru: "Серия" }, value: "FLATX" },
      { label: { uz: "Quvvat", ru: "Мощность" }, value: "2000 Vt / Вт" },
      { label: { uz: "Himoya darajasi", ru: "Водонепроницаемость" }, value: "IPX4" },
      { label: { uz: "Kafolat", ru: "Гарантия" }, value: "3 yil / года" }
    ],
  ...
  },
  {
    ...
    images: [bleskNova],
    description: {
      uz: "BLESK B/NOVA - klassik vertikal suv isitgichlar seriyasi. Antikorrozion emalyali po'lat ichki idish. Mexanik isitish boshqaruvi. Kengaytirilgan magniy anod. Tor konstruksiya. Heat More texnologiyasi. Ti+ emalyali isitish elementi. IPX4 himoya darajasi. 3 yillik kafolat.",
      ru: "BLESK B/NOVA - серия классических вертикальных водонагревателей. Стальной внутренний бак покрытый антикоррозийной эмалью. Механическое управление нагревом. Увеличенный магниевый анод. Узкая конструкция. Технология Heat More. Нагревательный элемент Ti+ эмаль. Степень водонепроницаемости IPX4. 3 года гарантии."
    },
    specs: [
      { label: { uz: "Brend", ru: "Бренд" }, value: "BLESK" },
      { label: { uz: "Seriya", ru: "Серия" }, value: "NOVA" },
      { label: { uz: "Quvvat", ru: "Мощность" }, value: "2000 Vt / Вт" },
      { label: { uz: "Himoya darajasi", ru: "Водонепроницаемость" }, value: "IPX4" },
      { label: { uz: "Kafolat", ru: "Гарантия" }, value: "3 yil / года" }
    ],
  ...
  },
  {
    ...
    images: [bleskSlv],
    description: {
      uz: "BLESK B/SLV - ixcham vertikal suv isitgichlar seriyasi. Antikorrozion emalyali po'lat ichki idish. Mexanik isitish boshqaruvi. Kengaytirilgan magniy anod. Heat More texnologiyasi. Ti+ emalyali isitish elementi. IPX4 himoya darajasi. 3 yillik kafolat.",
      ru: "BLESK B/SLV - серия компактных вертикальных водонагревателей. Стальной внутренний бак покрытый антикоррозийной эмалью. Механическое управление нагревом. Увеличенный магниевый анод. Технология Heat More. Нагревательный элемент Ti+ эмаль. Степень водонепроницаемости IPX4. 3 года гарантии."
    },
    specs: [
      { label: { uz: "Brend", ru: "Бренд" }, value: "BLESK" },
      { label: { uz: "Seriya", ru: "Серия" }, value: "SLV" },
    ...
    variants: [
      {
        ...
        specs: [
          { label: { uz: "Hajmi", ru: "Объём" }, value: "50 litr / л" },
          { label: { uz: "O'lchamlari", ru: "Размер (H×W×D)" }, value: "890×370×405 mm" },
      ...
      },
      {
        ...
        specs: [
          { label: { uz: "Hajmi", ru: "Объём" }, value: "80 litr / л" },
          { label: { uz: "O'lchamlari", ru: "Размер (H×W×D)" }, value: "1055×411×458 mm" },
  ...
  },
  {
    ...
    images: [bleskVc],
    description: {
      uz: "BLESK B/VC - tor vertikal suv isitgichlar seriyasi. Antikorrozion emalyali po'lat ichki idish. Mexanik isitish boshqaruvi. Kengaytirilgan magniy anod. Tor konstruksiya. Heat More texnologiyasi. Ti+ emalyali isitish elementi. IPX4 himoya darajasi. 3 yillik kafolat.",
      ru: "BLESK B/VC - серия узких вертикальных водонагревателей. Стальной внутренний бак покрытый антикоррозийной эмалью. Механическое управление нагревом. Увеличенный магниевый анод. Узкая конструкция. Технология Heat More. Нагревательный элемент Ti+ эмаль. Степень водонепроницаемости IPX4. 3 года гарантии."
    },
    specs: [
      { label: { uz: "Brend", ru: "Бренд" }, value: "BLESK" },
      { label: { uz: "Seriya", ru: "Серия" }, value: "VC" },
      { label: { uz: "Quvvat", ru: "Мощность" }, value: "1500 Vt / Вт" },
      { label: { uz: "Himoya darajasi", ru: "Водонепроницаемость" }, value: "IPX4" },
      { label: { uz: "Kafolat", ru: "Гарантия" }, value: "3 yil / года" }
    ],
  ...
  },
  {
    ...
    description: {
      uz: "BLESK B/MI - ixcham kvadrat suv isitgichlar seriyasi. Turbo isitish elementlari orqali tezkor isish. Antikorrozion emalyali po'lat ichki idish. Kengaytirilgan magniy anod. Heat More texnologiyasi. Ti+ emalyali isitish elementi. IPX4 himoya darajasi. 3 yillik kafolat.",
      ru: "BLESK B/MI - серия компактных квадратных водонагревателей. Быстрый нагрев благодаря турбо нагревательным элементам. Стальной внутренний бак покрытый антикоррозийной эмалью. Увеличенный магниевый анод. Технология Heat More. Нагревательный элемент Ti+ эмаль. Степень водонепроницаемости IPX4. 3 года гарантии."
    },
    specs: [
      { label: { uz: "Brend", ru: "Бренд" }, value: "BLESK" },
      { label: { uz: "Seriya", ru: "Серия" }, value: "MI / MI-X" },
      { label: { uz: "Himoya darajasi", ru: "Водонепроницаемость" }, value: "IPX4" },
      { label: { uz: "Kafolat", ru: "Гарантия" }, value: "3 yil / года" }
    ],
    variants: [
  ...
  },
  {
    ...
    name: "BLESK B/NEO",
    category: "blesk",
    images: [bleskNeo, bleskNeoSide],
    description: {
      uz: "BLESK B/NEO - ixcham kvadrat suv isitgichlar seriyasi. Turbo isitish elementlari orqali tezkor isish. Antikorrozion emalyali po'lat ichki idish. Kengaytirilgan magniy anod. Heat More texnologiyasi. Ti+ emalyali isitish elementi. IPX4 himoya darajasi. 3 yillik kafolat.",
      ru: "BLESK B/NEO - серия компактных квадратных водонагревателей. Быстрый нагрев благодаря турбо нагревательным элементам. Стальной внутренний бак покрытый антикоррозийной эмалью. Увеличенный магниевый анод. Технология Heat More. Нагревательный элемент Ti+ эмаль. Степень водонепроницаемости IPX4. 3 года гарантии."
    },
    specs: [
      { label: { uz: "Brend", ru: "Бренд" }, value: "BLESK" },
      { label: { uz: "Seriya", ru: "Серия" }, value: "NEO" },
      { label: { uz: "Quvvat", ru: "Мощность" }, value: "2000 Vt / Вт" },
      { label: { uz: "Himoya darajasi", ru: "Водонепроницаемость" }, value: "IPX4" },
      { label: { uz: "Kafolat", ru: "Гарантия" }, value: "3 yil / года" }
    ],
    variants: [
      {
        ...
        specs: [
          { label: { uz: "Hajmi", ru: "Объём" }, value: "10 litr / л" },
          { label: { uz: "O'lchamlari", ru: "Размер (H×W×D)" }, value: "324×324×315 mm" },
          { label: { uz: "Og'irligi", ru: "Вес" }, value: "7.5 kg" }
        ]
      },
      {
        id: "blesk-neo150",
        ...
        specs: [
          { label: { uz: "Hajmi", ru: "Объём" }, value: "15 litr / л" },
          { label: { uz: "O'lchamlari", ru: "Размер (H×W×D)" }, value: "368×368×340 mm" },
          { label: { uz: "Og'irligi", ru: "Вес" }, value: "9.6 kg" }
        ]
      },
      {
        id: "blesk-neo300",
        ...
        specs: [
          { label: { uz: "Hajmi", ru: "Объём" }, value: "30 litr / л" },
          { label: { uz: "O'lchamlari", ru: "Размер (H×W×D)" }, value: "440×440×420 mm" },
          { label: { uz: "Og'irligi", ru: "Вес" }, value: "13.5 kg" }
        ]
      }
    ]
  },
  {
    ...
    images: [bleskFl],
    description: {
      uz: "BLESK B/FL - ikki kamerali suv isitgichlar seriyasi. Ikki po'lat idish emalyali qoplama bilan. Ikki isitish elementi orqali turbo isitish. Elektron isitish boshqaruvi. Quruq Ten texnologiyasi. Universal o'rnatish (vertikal va gorizontal). Heat More texnologiyasi. Ti+ emalyali isitish elementi. IPX4 himoya darajasi. 3 yillik kafolat.",
      ru: "BLESK B/FL - серия водонагревателей с двумя камерами. Два стальных внутренних бака с эмалированным покрытием. Турбо нагрев благодаря двум нагревательным элементам. Электронное управление нагревом. Технология использования сухих Тенов. Универсальная установка (вертикально и горизонтально). Технология Heat More. Нагревательный элемент Ti+ эмаль. Степень водонепроницаемости IPX4. 3 года гарантии."
    },
    specs: [
      { label: { uz: "Brend", ru: "Бренд" }, value: "BLESK" },
      { label: { uz: "Seriya", ru: "Серия" }, value: "FL" },
      { label: { uz: "Quvvat", ru: "Мощность" }, value: "2000 Vt / Вт" },
      { label: { uz: "Himoya darajasi", ru: "Водонепроницаемость" }, value: "IPX4" },
      { label: { uz: "Kafolat", ru: "Гарантия" }, value: "3 yil / года" }
    ],
